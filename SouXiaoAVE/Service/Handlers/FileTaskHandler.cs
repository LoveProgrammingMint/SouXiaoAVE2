...
public sealed class FileTaskHandler : ITaskHandler
{
    private Boolean _disposed = false;
    private Boolean _cancelled = false;

    public SXType SupportedType => SXType.File;

    public String HandlerName => "File Scan Handler";

    public Boolean CanHandle(SXTask task) => task.Type == SXType.File && task.IsValid;
