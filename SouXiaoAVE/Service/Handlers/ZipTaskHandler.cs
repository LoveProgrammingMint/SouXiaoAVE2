...
public sealed class ZipTaskHandler : ITaskHandler
{
    private Boolean _disposed = false;
    private Boolean _cancelled = false;

    public SXType SupportedType => SXType.Zip;

    public String HandlerName => "Zip Archive Scan Handler";

    public Boolean CanHandle(SXTask task) => task.Type == SXType.Zip && task.IsValid;
